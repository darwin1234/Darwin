...
JLoader::registerPrefix('Talentpro', JPATH_SITE . '/components/com_talentpro/');

/**
 * Class TalentproRouter
 *
 * @since  3.3
 */
class TalentproRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = TalentproHelpersTalentpro::getModel($view);
				if($model !== null)
				{
	...
	public function parse(&$segments)
	{
		...
		$model        = TalentproHelpersTalentpro::getModel($vars['view']);
