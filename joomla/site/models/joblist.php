...
/**
 * Methods supporting a list of Talentpro records.
 *
 * @since  1.6
 */
class TalentproModelJoblist extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_talentpro'))
		{
			$query->where('a.state = 1 AND applicationdeadline > NOW()');
		}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_TALENTPRO_SEARCH_FILTER_DATE_FORMAT"), "warning");
