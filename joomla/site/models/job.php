 ...
 * @since  1.6
 */
class TalentproModelJob extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_talentpro')) && (!$user->authorise('core.edit', 'com_talentpro')))
		{
            ...
            if ($this->_item === null)
            {
                ...
                if ($table->load($id))
                {
                    ...
                    if ($published = $this->getState('filter.published'))
                    {
                        ...
                        {
                            throw new Exception(JText::_('COM_TALENTPRO_ITEM_NOT_LOADED'), 403);
                        }
                    }
