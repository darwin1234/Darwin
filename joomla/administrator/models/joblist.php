...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_talentpro');
		$this->setState('params', $params);

		// List state information.
		parent::populateState('a.positiontype', 'asc');
	}
	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.positiontype LIKE ' . $search . '  OR  a.title LIKE ' . $search . '  OR  a.category LIKE ' . $search . ' )');
			}
		}
