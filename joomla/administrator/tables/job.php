 ...
 * @since  1.6
 */
class TalentproTablejob extends JTable
{
	/**
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'TalentproTablejob', array('typeAlias' => 'com_talentpro.job'));
		parent::__construct('#__jobspro_', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_talentpro.job.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_talentpro/access.xml',
				"/access/section[@name='job']/"
			);
			$default_actions = JAccess::getAssetRules('com_talentpro.job.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_talentpro.job.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_talentpro');
